...
@section('content')
    <div class="min-h-screen py-8 px-4 md:px-8">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-6">
            <form action="{{ route('pembimbing-akademik.update', $pembimbingAkademik) }}" method="POST" class="space-y-8">
                @csrf
                @method('PUT')
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="nama" id="nama" value="{{ old('nama', $pembimbingAkademik->nama) }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 @error('nama') border-red-500 @enderror" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="nip" id="nip" value="{{ old('nip', $pembimbingAkademik->nip) }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 @error('nip') border-red-500 @enderror" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="kontak" id="kontak" value="{{ old('kontak', $pembimbingAkademik->kontak) }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 @error('kontak') border-red-500 @enderror" required>
                            @error('kontak')<p class="mt-1 text-sm text-red-500">{{ $message }}</p>@enderror
                        </div>
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Email <span class="text-red-500">*</span></label>
                            <input type="email" name="email" id="email" value="{{ old('email', $pembimbingAkademik->email) }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 @error('email') border-red-500 @enderror" required>
