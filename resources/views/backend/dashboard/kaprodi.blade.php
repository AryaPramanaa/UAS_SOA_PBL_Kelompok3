        ...
        <nav id="sidebar"
            ...
            <div class="flex-1 flex flex-col justify-between overflow-y-auto">
                <ul class="px-4 py-6 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('kaprodi.rekapMahasiswaPKL.index') }}"
                            class="flex items-center gap-x-3 px-4 py-3 rounded-lg {{ request()->is('kaprodi/rekapMahasiswaPKL*') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-100' }} transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('kaprodi.profil.edit') }}"
                            class="flex items-center gap-x-3 px-4 py-3 rounded-lg {{ request()->is('kaprodi/profil/edit') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-100' }} transition-colors cursor-pointer"
                    ...
                    <div class="px-4 py-3 rounded-lg bg-gray-100 mb-4 flex items-center gap-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 sidebar-label transition-all duration-200 origin-left">
                                {{ Auth::user()->role }}</p>
                            @if (Auth::user()->prodi)
                                <p class="text-xs text-green-600 sidebar-label transition-all duration-200 origin-left">
                                    {{ Auth::user()->prodi->nama_prodi }}</p>
                            @endif
                        </div>
                    </div>
                    <a href="{{ route('logout') }}"
