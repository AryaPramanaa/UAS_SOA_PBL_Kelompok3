...
@section('content')
    <div class="min-h-screen py-8 px-4 md:px-8">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            <form action="{{ route('perusahaan.lowonganPKL.store') }}" method="POST" class="space-y-6">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="kuota" id="kuota" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 @error('kuota') border-red-500 @enderror" value="{{ old('kuota') }}" placeholder="Masukkan kuota peserta" required>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="3" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi') }}</textarea>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="syarat" id="syarat" rows="3" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 @error('syarat') border-red-500 @enderror">{{ old('syarat') }}</textarea>
