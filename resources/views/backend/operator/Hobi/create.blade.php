...
<div class="px-6 py-8">
    <div class="relative mb-6">
        ...
        <div class="text-center">
            <h1 class="text-4xl font-bold text-gray-800 mb-2">Tambah Hobi</h1>
    ...
    <div class="max-w-4xl mx-auto bg-white rounded-xl shadow p-8">
            <form action="{{ route('operator.hobi.store') }}" method="POST" class="space-y-6">
                @csrf
        ...
        <div>
            ...
            <input type="text" name="hobi" value="{{ old('hobi') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none">
        </div>
