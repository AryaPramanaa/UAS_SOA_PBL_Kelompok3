                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-600 mb-1">KTM (Kartu Tanda Mahasiswa)</label>
                            ...
                            @if($pengajuan->cv)
                            <div>
                                <label class="block text-sm font-medium text-gray-600 mb-1">CV (Curriculum Vitae)</label>
                                <div class="flex items-center space-x-3 mb-3">
