    ...
    <div class="bg-white rounded-xl shadow-lg p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            <div>
                ...
                <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-100" value="{{ \Carbon\Carbon::parse($laporan->pengajuanPKL->tanggal_pengajuan)->format('d/m/Y') ?? '-' }}" readonly>
            </div>
        </div>
        <div class="mt-6">
